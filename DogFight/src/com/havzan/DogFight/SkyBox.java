...
//	}
	...
	void render(PerspectiveCamera cam)
	{
		...
		Matrix4 m = new Matrix4();
		m.translate(cam.position.x, cam.position.y, cam.position.z).scale(2000, 2000, 2000);
		...
		Gdx.gl.glTexParameterf(GL10.GL_TEXTURE_2D, GL10.GL_TEXTURE_WRAP_S, TextureWrap.ClampToEdge.getGLEnum());
		Gdx.gl.glTexParameterf(GL10.GL_TEXTURE_2D, GL10.GL_TEXTURE_WRAP_T, TextureWrap.ClampToEdge.getGLEnum());
